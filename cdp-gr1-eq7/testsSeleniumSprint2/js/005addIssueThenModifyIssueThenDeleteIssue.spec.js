...
describe('005_addIssueThenModifyIssueThenDeleteIssue', function() {
  ...
  it('005_addIssueThenModifyIssueThenDeleteIssue', async function() {
    ...
    await driver.findElement(By.id('issueDescription')).click()
    await driver
      .findElement(By.id('issueDescription'))
      .sendKeys(
        'As a member I want to create a new project In order to work on it'
      )
    ...
    await driver
      .findElement(By.id('issueDescription'))
      .sendKeys(
        'As a user I want to create an account In order to create and manage my projects'
      )
    ...
    await driver
      .findElement(By.id('issueDescription'))
      .sendKeys(
        'As a member of a project I want to create a new issue In order to see it in the list of issue'
      )
    await driver.findElement(By.css('.float-right:nth-child(1)')).click()
    ...
    await driver
      .findElement(By.id('issueDescription'))
      .sendKeys(
        'As a user I want to create an account In order to create a project'
      )
    await driver.findElement(By.css('.float-right')).click()
    ...
    assert(
      (await driver
        .switchTo()
        .alert()
        .getText()) == 'Voulez-vous vraiment supprimer cette issue ?'
    )
    await driver
      .switchTo()
      .alert()
