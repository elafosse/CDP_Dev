...
describe('007_addTestThenModifyTestThenDeleteTest', function() {
  ...
  it('007_addTestThenModifyTestThenDeleteTest', async function() {
    ...
    await driver
      .findElement(By.id('testResultExpected'))
      .sendKeys('jtyhtgrghyjèuhtdbfhryhtf2gb3435456h4y65yr')
    ...
    await driver
      .findElement(By.css('.list-inline-item:nth-child(1) > .custom-control'))
      .click()
    await driver
      .findElement(
        By.css('.list-inline-item:nth-child(1) .custom-control-label')
      )
      .click()
    await driver
      .findElement(
        By.css('.list-inline-item:nth-child(2) .custom-control-label')
      )
      .click()
    ...
    await driver
      .findElement(By.id('testDescription'))
      .sendKeys('hyrrhtrtrh35446gf3bgf3f')
    ...
    assert(
      (await driver
        .switchTo()
        .alert()
        .getText()) == 'Voulez-vous vraiment supprimer ce test ?'
    )
    await driver
      .switchTo()
      .alert()
