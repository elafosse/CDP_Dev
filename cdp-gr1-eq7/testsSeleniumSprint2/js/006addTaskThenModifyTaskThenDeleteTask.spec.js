...
describe('006_addTaskThenModifyTaskThennDeleteTask', function() {
  ...
  it('006_addTaskThenModifyTaskThennDeleteTask', async function() {
    ...
    await driver.findElement(By.id('taskDoD')).click()
    await driver
      .findElement(By.id('taskDoD'))
      .sendKeys('Ceci est une task sans description')
    ...
    await driver
      .findElement(By.id('taskDescription'))
      .sendKeys('Ceci est une task sans DoD')
    ...
    await driver
      .findElement(By.id('taskDescription'))
      .sendKeys('Ceci est une task modifée')
    await driver.findElement(By.id('taskName')).click()
    ...
    await driver
      .findElement(
        By.css('#tasks_doing > .list-group-item:nth-child(2) > .mb-1')
      )
      .click()
    await driver.findElement(By.linkText('Modify')).click()
    {
    ...
    }
    {
      const element = await driver.findElement(
        By.css('#taskRequired > option:nth-child(1)')
      )
      await driver
        .actions({ bridge: true })
        .doubleClick(element)
    ...
    await driver.findElement(By.linkText('Modify')).click()
    await driver
      .findElement(By.css('.form-check:nth-child(5) > .form-check-label'))
      .click()
    await driver.findElement(By.id('startDate')).click()
    ...
    {
      const element = await driver.findElement(
        By.css('.list-group-item:nth-child(4)')
      )
      await driver
        .actions({ bridge: true })
    ...
    assert(
      (await driver
        .switchTo()
        .alert()
        .getText()) == 'Voulez-vous vraiment supprimer cette tâche ?'
    )
    await driver
      .switchTo()
      .alert()
