...
Pour la difficulté et l’importance, nous avons utilisé Fibonacci
...
* un nom d'utilisateur unique sous forme de chaîne de caractères (20 char max)
* un mot de passe sous forme de chaîne de caractères. 

I1 (8, 13) -> En tant que visiteur, je souhaite me connecter à mon compte en cliquant sur un bouton "Connexion" afin d'avoir accès à mes projets. La page de connexion doit me demander :
* mon nom d'utilisateur unique sous forme de chaîne de caractères
* mon mot de passe sous forme de chaîne de caractères. 

Une message d'erreur doit apparaître si le couple nom d'utilisateur/mot de passe entré ne correspond à aucun compte.

I2 (1, 8) -> En tant que connecté, je souhaite pouvoir me déconnecter en cliquant sur un bouton "Déconnexion", afin de supprimer ma session en cours.
...
I4 (5, 8) -> En tant que créateur du projet, je souhaite pouvoir inviter d'autres membres à mon projet en :
* cliquant sur un bouton "Ajouter un membre"
* spécifiant son nom d'utilisateur
...
I9 (5, 13) -> En tant que membre d'un projet et en étant sur la liste des issues d'un projet, je souhaite pouvoir créer une Issue en cliquant sur "Ajouter Issue" et en spécifiant :
* un nom
* une description
* une priorité 
* une difficulté (l'id sera créé automatiquement)
...
I12 (5, 13) -> En tant que membre d'un projet, je souhaite pouvoir accéder à la liste des tâches d'un projet sous forme de tableau avec 
* les tâches à faire
* les tâches en cours
...
I17 (8, 5) -> En tant que membre du projet et une fois sur la description de la tâche, je souhaite pouvoir modifier les détails de la tâche, puis confirmer les changements cliquant sur le bouton "Enregistrer" afin de pouvoir modifier facilement le contenu d'une tâche.
...
I18 (8, 8) -> En tant que membre du projet, je souhaite avoir accès à une liste de releases existantes. 
I19 (5, 8) -> En tant que membre du projet une fois sur la liste des releases, je souhaite pouvoir créer une release en appuyant sur le bouton "Créer Release" en spécifiant :
* un nom
* une description 
* le lien vers la release
* les issues auxquelles elle répond.

I20 (8, 2) -> En tant que membre du projet une fois sur la liste des releases, je souhaite pouvoir modifier une release en appuyant sur le bouton "Modifier Release" à coté de la release concernée, puis en modifiant les champs nécessaires (nom, description, lien vers la release sur un dépôt, issues auxquelles elle répond) avant de confirmer la modification. 

I21 (5, 5) -> En tant que membre du projet une fois sur la liste des releases, je souhaite pouvoir supprimer une release en appuyant sur le bouton "Supprimer Release" à coté de la release concernée, puis en confirmant mon choix.  
...
I22 (13, 8) -> En tant que membre du projet, je souhaite avoir accès à la documentation disponible du projet en sachant à quelle version elle correspond afin d'être capable de comprendre et d'utiliser le logiciel facilement. 

I23 (13, 8) -> En tant que membre du projet, je souhaite pouvoir ajouter de la documentation concernant une version released en cliquant sur un bouton "Ajouter Documentation" pour 
* spécifier la version du logiciel
* la lier à une release 
* déposer le document 

I24 (13, 2) -> En tant que membre du projet, je souhaite pouvoir modifier une documentation existante en cliquant sur un bouton "Modifier Documentation" permettant de remplacer une documentation par une autre.

I25 (8, 8) -> En tant que membre du projet, je souhaite pouvoir supprimer une documentation existante en cliquant sur un bouton "Supprimer Documentation" et en confirmant mon choix. 
...
I26 (5, 8) -> En tant que membre du projet, je souhaite avoir accès à une liste des tests ayant été faits et ceux encore à faire afin de m'aider à comprendre l'avancement des tests dans le projet. 

I27 (5, 8) -> En tant que membre du projet, je souhaite pouvoir ajouter un test dans la liste des tests à effectuer en appuyant sur un bouton "Ajouter Test", puis en spécifiant :
* un nom
* une description de la fonction à tester et du résultat attendu par celui-ci 
* en le liant à une issue.
* en précisant la dernière version pour laquelle le test a été validé

I28 (8, 8) -> En tant que membre du projet, je souhaite pouvoir modifier l'état d'un test ("A coder" ou "Fait") afin de comprendre rapidement quels tests ont été faits, et ceux restant à coder dans l'application. 

I29 (8, 5) -> En tant que membre du projet et en étant sur la liste des tests, je souhaite pouvoir modifier un test en cliquant sur un bouton "Modifier Test" et en modifiant :
* le nom
* la description
* la dernière version pour laquelle le test a été validé 

I30 (3, 8) -> En tant que membre du projet et en étant sur la liste des tests, je souhaite pouvoir supprimer un test en cliquant sur le bouton "Supprimer" à coté du test correspondant. 
...
I12 (5, 13) -> En tant que membre d'un projet, je souhaite pouvoir accéder à la liste des sprints d'un projet sous forme de tableau avec 
* les sprint à faire
* les sprint en cours
* les sprint terminés. 
